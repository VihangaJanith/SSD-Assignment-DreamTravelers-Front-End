...
export default function RegisterUser({ }) {
	...
	function sendData() {
		...
		if (!passwordPattern.test(Password)) {
			alert("Password should contain at least one special character, one capital letter, one simple letter, one numeric character, and be at least 8 characters long.");
			return 0
		} else {
